...
# 点击支付申请录入（单位）菜单
wd.find_element(By.XPATH,'//*[@id="app"]/div/div[3]/div[2]/div/div/div[1]/div[2]/div[2]/div/div[2]/div/div/span[2]').click()
time.sleep(2)

# 选择数据 !!!
wd.find_element(By.XPATH,'//*[@id="app"]/div/div[3]/div[2]/div/div[1]/div/div[2]/div/div[3]/main/div/div[1]/div[2]/div[2]/div[2]/table/tbody/tr/td[4]/div').click()
# 点击新增
...
# 选择数据
wd.find_element(By.XPATH,'//*[@id="app"]/div/div[3]/div[2]/div/div[1]/div/div[2]/div/div[3]/main/div/div[1]/div[2]/div[2]/div[2]/table/tbody/tr[1]/td[7]/div/span').click()
time.sleep(1)
# 点击送审
...
# 点击支付申请审核（单位）菜单
wd.find_element(By.XPATH,'//*[@id="app"]/div/div[3]/div[2]/div/div/div[1]/div[2]/div[2]/div/div[2]/div/div/span[4]').click()
time.sleep(2)
# 选择数据
wd.find_element(By.XPATH,'//*[@id="app"]/div/div[3]/div[2]/div/div[1]/div/div[2]/div/div[3]/main/div/div[1]/div[2]/div[2]/div[2]/table/tbody/tr[1]/td[5]/div').click()
time.sleep(1)
# 点击审核
wd.find_element(By.XPATH,'//*[@id="app"]/div/div[3]/div[2]/div/div[1]/div/div[1]/div[1]/div/ul/li[2]/div/ul/li[1]/button').click()
...
# 点击支付凭证生成（单位）菜单
wd.find_element(By.XPATH,'//*[@id="app"]/div/div[3]/div[2]/div/div/div[1]/div[2]/div[2]/div/div[2]/div/div/span[5]').click()
time.sleep(2)
# 选择数据
wd.find_element(By.XPATH,'//*[@id="app"]/div/div[3]/div[2]/div/div[1]/div/div[2]/div/div[3]/main/div/div[1]/div[2]/div[3]/div[2]/table/tbody/tr[1]/td[5]/div').click()
time.sleep(1)
# 点击生成
wd.find_element(By.XPATH,'//*[@id="app"]/div/div[3]/div[2]/div/div[1]/div/div[1]/div[1]/div/ul/li[2]/div/ul/li/button').click()
time.sleep(1)
...
# 点击支付凭证签名
wd.find_element(By.XPATH,'//*[@id="app"]/div/div[3]/div[2]/div/div/div[1]/div[2]/div[2]/div/div[2]/div/div/span[7]').click()
time.sleep(1)
# 选择数据
wd.find_element(By.XPATH,'//*[@id="app"]/div/div[3]/div[2]/div/div[1]/div/div[2]/div/div[3]/main/div/div[1]/div[2]/div[3]/div[2]/table/tbody/tr[1]/td[5]/div').click()
time.sleep(1)
# 点击签名
wd.find_element(By.XPATH,'//*[@id="app"]/div/div[3]/div[2]/div/div[1]/div/div[1]/div[1]/div/ul/li[2]/div/ul/li[2]/button').click()
time.sleep(5)

os.system("E:\\pypro\\AutoIT\\QmPassword.exe")
